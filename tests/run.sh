...
# Минимум кейсов на сьют (второе число маркера N/N; сейчас app 1623, worker 267,
# worker-async 54, sync-sim 223) — защита от случайно урезанного/не подхваченного файла кейсов.
...
# E4 (воркер, вне блока E4 клиента): writeRow/writeCommitted получили тот же wid, что у клиента (та же дыра
# равного rev двух писателей) — worker 264 → 267, worker-async 50 → 54.
MIN_CASES_app=1560
