...
const DICT: Dict = {
  ...
  sectors: ['Сектора', 'Sectors'],
  diversification: ['Диверсификация', 'Diversification'],
  trades: ['Сделки', 'Trades'],
  concentration: ['Концентрация', 'Concentration'],
  topHolding: ['Крупнейшая позиция', 'Top holding'],
  top3: ['Топ-3 доля', 'Top-3 weight'],
  hhi: ['Индекс HHI', 'HHI index'],
  sectorsN: ['Секторов', 'Sectors'],
  currencies: ['Валют', 'Currencies'],
  realizedPL: ['Реализованный P&L', 'Realized P&L'],
  noTrades: ['Сделок пока нет', 'No trades yet'],
  share: ['Доля', 'Share'],
  perDay: ['За день', 'Day'],
  count: ['Кол-во', 'Count'],
  history: ['История сделок', 'Trade history'],
  fee: ['комис.', 'fee'],
  wellDiversified: ['Хорошо диверсифицирован', 'Well diversified'],
  moderate: ['Умеренная концентрация', 'Moderately concentrated'],
  concentrated: ['Высокая концентрация', 'Highly concentrated'],
};
